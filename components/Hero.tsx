...
export default function Hero() {
  ...
  return (
    <div className="relative w-full h-screen xm:min-h-screen sm:min-h-screen overflow-hidden">
  ...
  />
      ...
      <div className="w-full h-full flex flex-col justify-center items-center lg:items-start text-center lg:text-left px-6 lg:px-0 relative z-10">
        ...
        <div className="w-full lg:max-w-[900px] lg:ml-12">
          ...
          {/* TITLE */}
          <h2 className="text-4xl lg:text-7xl sm:text-3xl font-[Inter] text-white drop-shadow-lg">
            {hero.title}
          </h2>
